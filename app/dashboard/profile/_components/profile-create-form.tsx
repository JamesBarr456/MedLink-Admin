...
const ProfileCreateForm: React.FC<ProfileFormType> = ({
  ...
  const title = initialData ? 'Editar producto' : 'Crea tu perfil';
  const description = initialData
    ? 'Editar un producto.'
    : 'Para crear tu perfil, primero necesitamos información básica sobre ti.';
                                ...
                                >
                                  <FormControl>
                                    <SelectTrigger>
                                      <SelectValue
                                        defaultValue={field.value}
                                        placeholder="Seleccione el país de su trabajo"
                                      />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent>
                                ...
                                >
                                  <FormControl>
                                    <SelectTrigger>
                                      <SelectValue
                                        defaultValue={field.value}
                                        placeholder="Seleccione la ciudad de su trabajo"
                                      />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent>
